...
Material emerald 	      = Material(vec3(0.0215, 0.1745, 0.0215)      ,vec3(0.07568, 0.61424, 0.07568),		vec3(0.633, 0.727811, 0.633),			 0.6, vec3(0.0));
Material jade		       	= Material(vec3(0.135, 0.2225, 0.1575)       ,vec3(0.54, 0.89, 0.63),				vec3(0.316228, 0.316228, 0.316228),		 0.1, vec3(0.0));
Material obsidian		    = Material(vec3(0.05375, 0.05, 0.06625)		 ,vec3(0.18275, 0.17, 0.22525),			vec3(0.332741, 0.328634, 0.346435),		 0.3, vec3(0.0));
Material pearl			    = Material(vec3(0.25, 0.20725, 0.20725)		 ,vec3(1.0, 0.829, 0.829),				vec3(0.296648, 0.296648, 0.296648),		 0.088, vec3(0.0));
...
Material black_plastic	= Material(vec3(0.0, 0.0, 0.0),				  vec3(0.01, 0.01, 0.01),				vec3(0.50, 0.50, 0.50),					 0.25, vec3(0.0));
Material cyan_plastic	  = Material(vec3(0.0, 0.1, 0.06),			  vec3(0.0, 0.50980392, 0.50980392),	vec3(0.50196078, 0.50196078, 0.50196078),0.25, vec3(0.0));
Material green_plastic	= Material(vec3(0.0, 0.0, 0.0),				  vec3(0.1, 0.35, 0.1),					vec3(0.45, 0.55, 0.45),					 0.25, vec3(0.0));
Material red_plastic	  = Material(vec3(0.0, 0.0, 0.0),				  vec3(0.5, 0.0, 0.0),					vec3(0.7, 0.6, 0.6),					 0.25, vec3(0.0));
Material white_plastic  = Material(vec3(0.0, 0.0, 0.0),				  vec3(0.55, 0.55, 0.55),				vec3(0.70, 0.70, 0.70),					 0.25, vec3(0.0));
Material yellow_plastic = Material(vec3(0.0, 0.0, 0.0),				  vec3(0.5, 0.5, 0.0),					vec3(0.60, 0.60, 0.50),					 0.25, vec3(0.0));
Material black_rubber   = Material(vec3(0.02, 0.02, 0.02),			  vec3(0.01, 0.01, 0.01),				vec3(0.4, 0.4, 0.4),					 0.078125, vec3(0.0));
Material cyan_rubber    = Material(vec3(0.0, 0.05, 0.05),			  vec3(0.4, 0.5, 0.5),					vec3(0.04, 0.7, 0.7),					 0.078125, vec3(0.0));
Material green_rubber	  = Material(vec3(0.0, 0.05, 0.0),			  vec3(0.4, 0.5, 0.4),					vec3(0.04, 0.7, 0.04),					 0.078125, vec3(0.0));
